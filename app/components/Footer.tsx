...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden bg-zinc-900 transition-colors duration-1000 ease-in-out dark:bg-zinc-950">
      <div className="relative z-10">
        ...
        <div className="container mx-auto pb-8 pt-4 text-center text-xs text-zinc-300 lg:px-12">
          &copy; {year} Go Canada, a division of Stay &amp; Wander Media Inc.
          All Rights Reserved.
        </div>
      </div>
      <BrandArrow
        ...
        width={"auto"}
        fill="white"
        className="absolute left-1/2 top-1/2 z-0 -translate-x-1/2 -translate-y-1/2 scale-125 opacity-[5%]"
      />
    </footer>
  )
}
