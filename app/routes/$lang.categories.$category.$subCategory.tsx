...
export const meta: MetaFunction<typeof loader> = ({
  ...
  const categoryTitle = data.category.title.en
  const subCategoryTitle = data.subCategory.title.en
  const subCategoryDescription = data.subCategory.description.en?.trim()
